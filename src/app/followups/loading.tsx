  ...
  return (
    <div className="flex flex-col gap-4 p-6" style={{ maxWidth: 1200 }}>
      ...
      <div className="flex gap-3">
        {[0, 1, 2, 3].map(i => (
          <div key={i} className="flex flex-col gap-2 flex-1 p-3" style={{ background: 'var(--surface-1)', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-subtle)' }}>
      ...
      <div className="flex flex-col gap-2">
        ...
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="flex items-center gap-4 p-3" style={{ background: 'var(--surface-1)', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-subtle)', opacity: 0.7 }}>
            <div className="skeleton" style={{ width: 32, height: 32, borderRadius: 'var(--radius-sm)' }} />
            <div className="flex flex-col gap-2 flex-1">
