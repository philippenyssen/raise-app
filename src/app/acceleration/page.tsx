...
const tabCountActive = { padding: 'var(--space-0) var(--space-1)', fontSize: 'var(--font-size-xs)', background: 'var(--accent-muted)', color: 'var(--accent)' } as const;
const tabCountInactive = { padding: 'var(--space-0) var(--space-1)', fontSize: 'var(--font-size-xs)', background: 'var(--surface-2)', color: 'var(--text-muted)' } as const;
