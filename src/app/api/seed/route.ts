...
import { createInvestor, setRaiseConfig, clearAllData } from '@/lib/db';
...
export async function POST() {
  try {
    ...
    const allInvestors = [...tier1, ...tier2, ...tier3];
    ...
    console.error('[SEED_POST]', error instanceof Error ? error.message : error);
