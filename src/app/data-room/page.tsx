    ...
    <div className="max-w-5xl space-y-6 page-content">
      ...
      {pasteMode && (
        <div
          ...
          <textarea value={pasteContent} onChange={e => setPasteContent(e.target.value)} placeholder="Paste contracts, financial summaries, meeting notes, or other text (max 50KB). Content will be indexed and searchable." rows={10} className="input" style={pasteTextareaStyle} maxLength={50000}
            />
