  ...
  return (
    <html>
      <body style={{ margin: 0, fontFamily: 'system-ui, sans-serif', background: 'var(--background)', color: 'var(--text-primary)' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', gap: 'var(--space-6)', padding: 'var(--space-8)' }}>
          ...
          <button
            onClick={reset}
            style={{ padding: 'var(--space-2) var(--space-5)', background: 'var(--accent)', color: 'var(--surface-0)', border: 'none', borderRadius: 'var(--radius-md)', cursor: 'pointer', fontSize: 'var(--font-size-sm)' }}
          >
            Retry
          </button>
        </div>
